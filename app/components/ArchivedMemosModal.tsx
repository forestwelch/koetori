                  ...
                  >
                    ...
                    <div className="mt-4 flex flex-wrap gap-2 justify-end">
                      <Button
                        ...
                        className="px-3 py-1.5 rounded-full bg-emerald-500/15 hover:bg-emerald-500/25 text-emerald-300 border border-emerald-500/30 text-xs font-medium transition-colors"
                      >
                        Restore
                      </Button>
                      <Button
                        ...
                        className="px-3 py-1.5 rounded-full bg-red-500/15 hover:bg-red-500/25 text-red-300 border border-red-500/30 text-xs font-medium transition-colors"
                      >
                        Delete Forever
                      </Button>
                    </div>
